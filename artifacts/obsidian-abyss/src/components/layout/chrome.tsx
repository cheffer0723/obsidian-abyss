    ...
    <>
      ...
      >
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 bg-primary rounded-sm shadow-[0_0_15px_rgba(0,255,255,0.8)]" />
          <span className="font-display font-bold tracking-widest text-sm text-white">OBSIDIAN ABYSS</span>
        </div>
